  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm">
        ...
        <p className="text-center mb-6">Enter your email and new password below</p>
        ...
        <button className="mt-4 text-blue-500 hover:underline flex items-center" onClick={() => handleNavigate("/profile")}>
